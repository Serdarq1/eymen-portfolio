// ============================================================
// CtaLight.js
// Full-screen ShaderMaterial running spotlight.vert/frag.
// All the work — the cone, dust particles, and floor pool —
// happens in the fragment shader. The JS side just feeds
// time / resolution / mouse uniforms.
// ============================================================
import * as THREE from 'three';
import vertexShader from './shaders/spotlight.vert';
import fragmentShader from './shaders/spotlight.frag';

export class CtaLight {
  constructor(container) {
    this.container = container;
    this.clock = new THREE.Clock();
    this.mouse = new THREE.Vector2(0.5, 0.3);
    this.targetMouse = new THREE.Vector2(0.5, 0.3);
    this._init();
    this._bind();
    this._resize();
    this._tick();
